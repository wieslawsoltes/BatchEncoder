...
|-----------------------|-------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------|
| Windows 32-bit        | Installer   | 1.2           | [BatchEncoder-1.2-Win32.exe](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/BatchEncoder-1.2-Win32.exe)           |
| Windows 64-bit        | Installer   | 1.2           | [BatchEncoder-1.2-x64.exe](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/BatchEncoder-1.2-x64.exe)               |
| Windows 32-bit        | Portable    | 1.2           | [BatchEncoder-1.2-Win32.zip](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/BatchEncoder-1.2-Win32.zip)           |
| Windows 64-bit        | Portable    | 1.2           | [BatchEncoder-1.2-x64.zip](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/BatchEncoder-1.2-x64.zip)               |
...
| Platform                   | Type        | Version       | Download                                                                                                                               |
|----------------------------|-------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------|
| Windows .NET4.5 (Any CPU)  | Portable    | 1.0.0         | [LanguageEditor-1.0.0-AnyCPU.zip](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/LanguageEditor-1.0.0-AnyCPU.zip) |
| Windows .NET4.5 (32-bit)   | Portable    | 1.0.0         | [LanguageEditor-1.0.0-x86.zip](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/LanguageEditor-1.0.0-x86.zip)       |
| Windows .NET4.5 (64-bit)   | Portable    | 1.0.0         | [LanguageEditor-1.0.0-x64.zip](https://github.com/wieslawsoltes/BatchEncoder/releases/download/1.2/LanguageEditor-1.0.0-x64.zip)       |
