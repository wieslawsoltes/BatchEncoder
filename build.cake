...
var packageBinariesAction = new Action<string,string> ((configuration, platform) => 
{
    ...
    CopyFiles("./config/formats/*.format", outputDir);
    CopyFiles("./config/lang/*.language", outputDir);
    CopyFiles("./config/progress/*.progress", outputDir);
    CopyFiles("./config/tools/*.tool", outputDir);
