...
rem
rem $Id: GetProgress_DeleteReleaseBuilds.cmd 437 2008-03-24 12:15:45Z wisodev $
setlocal
...
FOR /F "tokens=*" %%i IN (%ProgressNames%) DO (
    @del /Q "%BasePath%\Release\Win32\%%i.progress"
    @del /Q "%BasePath%\Release\x64\%%i.progress"
)
